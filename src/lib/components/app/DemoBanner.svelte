...
<div
	class="sticky top-0 z-40 shrink-0 border-b bg-red-600/70 pt-[env(safe-area-inset-top)] text-primary dark:bg-red-500/70"
>
	<div class="flex h-12 items-center gap-2 px-3 text-white">
