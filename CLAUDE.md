...
- `src/features/`: feature modules colocating screen logic and Svelte components by area (`budget/`, `accounts/`, `transactions/`, `payees/`, `reports/`, `settings/`, `onboarding/`, `welcome/`, `backup/`, `demo/`). Alias: `$features`.
